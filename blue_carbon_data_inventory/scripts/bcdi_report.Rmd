...
```{r inventory, echo=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
...
v1 <- read_csv("blue_carbon_data_inventory/tables/state_metrics_v1.csv") %>% 
  rename(spatial_metric = spatial_representativeness_metric)

v2 <- read_csv("blue_carbon_data_inventory/tables/state_metrics_v2.csv") %>% 
...
```{r change-map, echo=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
