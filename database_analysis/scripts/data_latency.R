...
ggsave("./figures/cores_sampled_per_year.jpg")

# join tables
dates <- left_join(core_dates, pub_dates) %>%
  drop_na(pub_year) # a few bib aren't aligning
...
ggsave("./figures/cores_sampled_v_published.jpg", width = 7, height = 3.5)
...
ggsave("./figures/data_latency.jpg")
