...
geo_directory = "D:/Pew-work/GIS-files/"

# State input files
states = "D:/Pew-work/GIS-files/coastal_conus_states_and_dc.shp"

# Create a list of input file names
input_names = ["CCAP_2206to2010_AllNwiTidal_And_Est.tif"]

output_names = ["CCAP_2206to2010_AllNwiTidal_And_Est"]

# Create a list of output files names
output_filepaths = ["D:/Pew-work/GIS-files/StateCcapClips"]

# Iterate through the states
# set up export tags
names = arcpy.da.SearchCursor(states, ["STUSPS"])
name_vect=[]
for row in names:
    string1 = str(row[0])
